...
const bulbMaterial = new THREE.MeshBasicMaterial({color: 0xbe7f53});
...
gltfLoader.load(
    ...
    (gltf) =>
    {
        gltf.scene.traverse((child) =>
        {
            ...
            }else if (child.name === "Mesh_133001_9"){
                interactiveObjects.push(child);
...
window.addEventListener('click', () =>
{
    ...
    { 
        ...
        switch(currentIntersect.object.name)
        {
            ...
            case "Mesh_133001_9":
                console.log('blah')
                if(bulbMaterial.color.equals(new THREE.Color(0xbe7f53))){
                    bulbMaterial.color = new THREE.Color(0xfdd671);
                }else{
                    bulbMaterial.color = new THREE.Color(0xbe7f53);
                }
                break;
        }
    }
